        ...
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4) {
                if (this.status == 200) {
                    ...
                    document.getElementById("notification").setAttribute("data-badge", notification_data.success.length);
                    ...
                    for (var i = 0; i < 5 && i < notification_data.success.length; i++) {
                        ...
                        listItem.className = "mdl-menu__item mdl-list__item list__item--border-top";

                        // Create and append the span element with the notification text
                        var spanElement = document.createElement("span");
                        spanElement.className = "mdl-list__item-primary-content";
