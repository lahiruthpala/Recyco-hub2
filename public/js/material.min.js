...
! function () {
    ...
    s = function () {
        ...
        function a(n, a) {
            ...
            var l = i("componentupgrading", !0, !0);
        ...
        function d(e) {
            if (e) {
                ...
                var a = i("componentdowngraded", !0, !1);
        ...
        "classList" in document.createElement("div") && "querySelector" in document && "addEventListener" in window && Array.prototype.forEach ? (document.documentElement.classList.add("js"), s.upgradeAllRegistered()) : (s.upgradeElement = function () {}, s.register = function () {})
    ...
    window.MaterialIconToggle = _, _.prototype.Constant_ = {
        ...
        INPUT: "icon-toggle__input",
        JS_RIPPLE_EFFECT: "js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "js-ripple-effect--ignore-events",
        RIPPLE_CONTAINER: "icon-toggle__ripple-container",
        RIPPLE_CENTER: "ripple--center",
        RIPPLE: "ripple",
        IS_FOCUSED: "is-focused",
        IS_DISABLED: "is-disabled",
    ...
    window.MaterialMenu = d, d.prototype.Constant_ = {
        ...
        if (this.element_) {
            ...
            var s = this.element_.getAttribute("for") || this.element_.getAttribute("data-for"),
                i = null;
    ...
    window.MaterialProgress = h, h.prototype.Constant_ = {}, h.prototype.CssClasses_ = {
        INDETERMINATE_CLASS: "progress__indeterminate"
    ...
    window.MaterialSpinner = u, u.prototype.Constant_ = {
        ...
        MDL_SPINNER_LAYER: "spinner__layer",
        MDL_SPINNER_CIRCLE_CLIPPER: "spinner__circle-clipper",
        MDL_SPINNER_CIRCLE: "spinner__circle",
        MDL_SPINNER_GAP_PATCH: "spinner__gap-patch",
        MDL_SPINNER_LEFT: "spinner__left",
        MDL_SPINNER_RIGHT: "spinner__right"
    ...
    window.MaterialTabs = m, m.prototype.Constant_ = {}, m.prototype.CssClasses_ = {
        ...
        MDL_RIPPLE_CONTAINER: "tabs__ripple-container",
        MDL_RIPPLE: "ripple",
    ...
    window.MaterialTooltip = I, I.prototype.Constant_ = {}, I.prototype.CssClasses_ = {
        ...
        if (this.element_) {
            var e = this.element_.getAttribute("for") || this.element_.getAttribute("data-for");
    ...
    window.MaterialLayout = f, f.prototype.Constant_ = {
        ...
        ICON: "material-icons",
        JS_RIPPLE_EFFECT: "js-ripple-effect",
        RIPPLE_CONTAINER: "layout__tab-ripple-container",
        RIPPLE: "ripple",
        RIPPLE_IGNORE_EVENTS: "js-ripple-effect--ignore-events",
        ...
        TAB_BAR: "layout__tab-bar",
        TAB_CONTAINER: "layout__tab-bar-container",
        TAB: "layout__tab",
        TAB_BAR_BUTTON: "layout__tab-bar-button",
        TAB_BAR_LEFT_BUTTON: "layout__tab-bar-left-button",
        TAB_BAR_RIGHT_BUTTON: "layout__tab-bar-right-button",
        TAB_MANUAL_SWITCH: "layout__tab-manual-switch",
        PANEL: "layout__tab-panel",
    ...
    window.MaterialDataTable = b, b.prototype.Constant_ = {}, b.prototype.CssClasses_ = {
        ...
        return t ? function () {
            ...
            var t, i;
            if (e.checked)
                for (t = 0; t < s.length; t++) i = s[t].querySelector("td").querySelector(".checkbox"), i.MaterialCheckbox.check(), s[t].classList.add(this.CssClasses_.IS_SELECTED);
            else
                for (t = 0; t < s.length; t++) i = s[t].querySelector("td").querySelector(".checkbox"), i.MaterialCheckbox.uncheck(), s[t].classList.remove(this.CssClasses_.IS_SELECTED)
        }.bind(this) : void 0
    }, b.prototype.createCheckbox_ = function (e, t) {
        var i = document.createElement("label"),
            n = ["checkbox", "js-checkbox", "js-ripple-effect", this.CssClasses_.SELECT_ELEMENT];
        i.className = n.join(" ");
        var a = document.createElement("input");
        return a.type = "checkbox", a.classList.add("checkbox__input"), e ? (a.checked = e.classList.contains(this.CssClasses_.IS_SELECTED), a.addEventListener("change", this.selectRow_(a, e))) : t && a.addEventListener("change", this.selectRow_(a, null, t)), i.appendChild(a), s.upgradeElement(i, "MaterialCheckbox"), i
    ...
    window.MaterialRipple = S, S.prototype.Constant_ = {
        ...
        RIPPLE_CENTER: "ripple--center",
        RIPPLE_EFFECT_IGNORE_EVENTS: "js-ripple-effect--ignore-events",
        RIPPLE: "ripple",
        IS_ANIMATING: "is-animating",
        IS_VISIBLE: "is-visible"
