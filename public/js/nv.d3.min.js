...
! function () {
    ...
    a.dev = !1, a.tooltip = a.tooltip || {}, a.utils = a.utils || {}, a.models = a.models || {}, a.charts = {}, a.logs = {}, a.dom = {}, a.dispatch = d3.dispatch("render_start", "render_end"), Function.prototype.bind || (Function.prototype.bind = function (a) {
        ...
        var d = "nvtooltip-" + Math.floor(1e5 * Math.random()),
            ...
            y = function (a) {
                var b, c, d, e = m.node().offsetHeight,
        ...
        function b(i) {
            return x.reset(), x.models(e), o && x.models(f), p && x.models(g), i.each(function (i) {
                ...
                var y = m.selectAll("g.nv-wrap.nv-discreteBarWithAxes").data([i]),
                    z = y.enter().append("g").attr("class", "nvd3 nv-wrap nv-discreteBarWithAxes").append("g"),
                    A = z.append("defs"),
                    B = y.select("g");
        ...
        var c, d, e = a.models.discreteBar(),
            ...
            t = 0,
            u = null,
            v = d3.dispatch("beforeUpdate", "renderEnd"),
            w = 250;
        f.orient("bottom").showMaxMin(!1).tickFormat(function (a) {
            return a
                ...
                x.on("mouseover", function (a, b) {
                    ...
                    if (l) {
                        if ("classic" == p) m ? (c.forEach(function (a) {
                            ...
                            if (n) a.disengaged = !a.disengaged, a.userDisabled = void 0 == a.userDisabled ? !!a.disabled : a.userDisabled, a.disabled = a.disengaged || a.userDisabled;
                            else if (!n) {
        ...
        function b(l) {
            return K.reset(), K.models(g), K.models(m), w && K.models(h), x && K.models(i), C && K.models(n),
                B && K.models(o), l.each(function (l) {
                    ...
                    a.utils.initSVG(Q);
                    var R = a.utils.availableWidth(t, Q, q),
                        S = a.utils.availableHeight(u, Q, q) - (A ? D : 0),
                        T = D - r.top - r.bottom;
                    if (b.update = function () {
                    ...
                    var V = Q.selectAll("g.nv-wrap.nv-lineChart").data([l]),
                        W = V.enter().append("g").attr("class", "nvd3 nv-wrap nv-lineChart").append("g"),
                        X = V.select("g");
                    ...
                    Z.append("g").attr("class", "nv-background").append("rect"), Z.append("g").attr("class", "nv-x nv-axis"), Z.append("g").attr("class", "nv-y nv-axis"), Z.append("g").attr("class", "nv-linesWrap"), Z.append("g").attr("class", "nv-brushBackground"), Z.append("g").attr("class", "nv-x nv-brush"), v && (j.width(R), X.select(".nv-legendWrap").datum(l).call(j), q.top != j.height() && (q.top = j.height(), S = a.utils.availableHeight(u, Q, q) - (A ? D : 0)), V.select(".nv-legendWrap").attr("transform", "translate(0," + -q.top + ")")), V.attr("transform", "translate(" + q.left + "," + q.top + ")"), y && X.select(".nv-y.nv-axis").attr("transform", "translate(" + R + ",0)"), z && (k.width(R).height(S).margin({
                        left: q.left,
                        top: q.top
                    }).svgContainer(Q).xScale(c), V.select(".nv-interactive").call(k)), X.select(".nv-focus .nv-background rect").attr("width", R).attr("height", S), g.width(R).height(S).color(l.map(function (a, b) {
                        return a.color || s(a, b)
                    }).filter(function (a, b) {
                        return !l[b].disabled
                    }));
                    ...
                    if (w && h.scale(c)._ticks(a.utils.calcTicksX(R / 100, l)).tickSize(-S, 0), x && i.scale(d)._ticks(a.utils.calcTicksY(S / 36, l)).tickSize(-R, 0), X.select(".nv-focus .nv-x.nv-axis").attr("transform", "translate(0," + S + ")"), A) {
                        ...
                        var aa = X.select(".nv-brushBackground").selectAll("g").data([E || p.extent()]),
                            ba = aa.enter().append("g");
                    ...
                    j.dispatch.on("stateChange", function (a) {
                        ...
                        if (l.filter(function (a, b) {
                                ...
                                var l = A ? p.empty() ? e.domain() : p.extent() : c.domain(),
                                    n = i.values.filter(function (a, b) {
                                        return g.x()(a, b) >= l[0] && g.x()(a, b) <= l[1]
                                    });
                                h = a.interactiveBisect(n, d.pointXValue, g.x());
                                var o = n[h],
                                    q = b.y()(o, h);
                                null !== q && g.highlightPoint(i.seriesIndex, h, !0), void 0 !== o && (void 0 === f && (f = o), void 0 === j && (j = b.xScale()(b.x()(o, h))), m.push({
                                    key: i.key,
                                    value: q,
                            ...
                            var n = b.yScale().invert(d.mouseY),
                                o = Math.abs(b.yScale().domain()[0] - b.yScale().domain()[1]),
                                q = .03 * o,
                        ...
                        l.filter(function (a, b) {
                            ...
                            var g = a.interactiveBisect(f.values, c.pointXValue, b.x()),
                                h = f.values[g];
        ...
        var c, d, e, f, g = a.models.line(),
            ...
            G = null,
            H = null,
            I = d3.dispatch("tooltipShow", "tooltipHide", "brush", "stateChange", "changeState", "renderEnd"),
            J = 250;
            ...
            return v.each(function (v) {
                ...
                function S() {
                    I = u.empty() ? null : u.extent(), c = u.empty() ? e.domain() : u.extent(), K.brush({
                        extent: c,
                        brush: u
                    }), R(), l.width(X).height(Y).color(v.map(function (a, b) {
                    ...
                    var b = fa.select(".nv-focus .nv-barsWrap").datum(_.length ? _.map(function (a, b) {
                        ...
                        h = fa.select(".nv-focus .nv-linesWrap").datum(V(aa) ? [{
                            values: []
                        }] : aa.filter(function (a) {
                            return !a.disabled
                        }).map(function (a, b) {
                            return {
                                area: a.area,
                ...
                var da = W.selectAll("g.nv-wrap.nv-linePlusBar").data([v]),
                    ea = da.enter().append("g").attr("class", "nvd3 nv-wrap nv-linePlusBar").append("g"),
                    fa = da.select("g");
                ...
                var ka = fa.select(".nv-context .nv-barsWrap").datum(_.length ? _ : [{
                    ...
                    la = fa.select(".nv-context .nv-linesWrap").datum(V(aa) ? [{
                        values: []
                    }] : aa.filter(function (a) {
                        return !a.disabled
                    }));
                ...
                var ma = fa.select(".nv-brushBackground").selectAll("g").data([I || u.extent()]),
        ...
        function b(B) {
            return G.reset(), G.models(e), s && G.models(f), t && G.models(g), B.each(function (B) {
                var G = d3.select(this),
                    K = this;
                a.utils.initSVG(G);
                var L = a.utils.availableWidth(m, G, l),
                    M = a.utils.availableHeight(n, G, l);
                if (b.update = function () {
                ...
                var O = G.selectAll("g.nv-wrap.nv-multiBarWithLegend").data([B]),
                ...
                t && (g.scale(d)._ticks(a.utils.calcTicksY(M / 36, B)).tickSize(-L, 0), Q.select(".nv-y.nv-axis").call(g)), F && (h.width(L).height(M).margin({
                    left: l.left,
                    top: l.top
                }).svgContainer(G).xScale(c), O.select(".nv-interactive").call(h)), i.dispatch.on("stateChange", function (a) {
                    ...
                    if (void 0 != a.pointXValue) {
                        ...
                        }), h.tooltip.chartContainer(K.parentNode).data({
                            value: g,
                            index: e,
                            series: i
                        })(), h.renderGuideLine(f)
            ...
            return j.each(function (j) {
                function n(a) {
                    ...
                    a.value = a.point.x, a.series = {
                        ...
                        color: a.point.color,
                        key: a.series.key
                    }, G.duration(0).valueFormatter(function (a, c) {
                ...
                function H(a) {
                    ...
                    a.value = a.point.x, a.series = {
                        ...
                        color: a.point.color,
                        key: a.series.key
                    }, G.duration(100).valueFormatter(function (a, c) {
                        return b.tickFormat()(a, c)
                    }).data(a).hidden(!1)
                }
                ...
                var $ = N.selectAll("g.wrap.multiChart").data([j]),
                    _ = $.enter().append("g").attr("class", "wrap nvd3 multiChart").append("g");
                ...
                var aa = $.select("g"),
                    ba = j.map(function (a, b) {
                        return j[b].color || f(a, b)
                    });
                if (i) {
                    var ca = F.align() ? O / 2 : O,
                        da = F.align() ? ca : 0;
                ...
                s.domain(c || d3.extent(d3.merge(Y).concat(ma), function (a) {
                    ...
                    b.update()
                }), p && (o.width(O).height(P).margin({
                    left: e.left,
                    top: e.top
                }).svgContainer(N).xScale(r), $.select(".nv-interactive").call(o)), p ? (o.dispatch.on("elementMousemove", function (c) {
                    L();
                    var d, e, g, h = [];
                    j.filter(function (a, b) {
                        ...
                        var m = l[e],
                            n = b.y()(m, e);
                        null !== n && M(j, e, !0), void 0 !== m && (void 0 === d && (d = m), void 0 === g && (g = r(b.x()(m, e))), h.push({
                            key: i.key,
                            value: n,
        ...
        var c, d, e = {
            ...
            m = "monotone",
            n = !0,
            o = a.interactiveGuideline(),
            p = !1,
            q = " (right axis)",
            r = d3.scale.linear(),
            s = d3.scale.linear(),
            t = d3.scale.linear(),
            u = a.models.line().yScale(s),
            v = a.models.line().yScale(t),
            w = a.models.scatter().yScale(s),
        ...
        function b(y) {
            return x.reset(), y.each(function (b) {
                ...
                var G = d3.select(this),
                    H = a.utils.availableWidth(g, G, f),
                    I = a.utils.availableHeight(h, G, f);
                ...
                var N = G.selectAll("g.nv-wrap.nv-parallelCoordinates").data([b]),
                    O = N.enter().append("g").attr("class", "nvd3 nv-wrap nv-parallelCoordinates"),
                    P = O.append("g"),
                    Q = N.select("g");
                ...
                var R, S, T = d3.behavior.drag().on("dragstart", C).on("drag", D).on("dragend", E),
                    U = i.range()[1] - i.range()[0];
                if (!isNaN(U)) {
                ...
                d = N.select(".background").selectAll("path").data(b), d.enter().append("path"), d.exit().remove(), d.attr("d", x), c = N.select(".foreground").selectAll("path").data(b), c.enter().append("path"), c.exit().remove(), c.attr("d", x).style("stroke-width", function (a, b) {
                    ...
                    d3.select(this).classed("hover", !0).style("stroke-width", a.strokeWidth + 2 + "px").style("stroke-opacity", 1), w.elementMouseover({
                        label: a.name,
                        color: a.color || o(a, b)
                    })
                }), c.on("mouseout", function (a, b) {
                    d3.select(this).classed("hover", !1).style("stroke-width", a.strokeWidth + "px").style("stroke-opacity", .7), w.elementMouseout({
                        label: a.name,
                        index: b
                    })
        ...
        function b(e) {
            return r.reset(), r.models(c), e.each(function (e) {
                ...
                a.utils.initSVG(j);
                var p = a.utils.availableWidth(g, j, f),
                    r = a.utils.availableHeight(h, j, f);
                b.update = function () {
                    j.call(b)
                ...
                var x = j.selectAll("g.nv-wrap.nv-parallelCoordinatesChart").data([e]),
                    y = x.enter().append("g").attr("class", "nvd3 nv-wrap nv-parallelCoordinatesChart").append("g"),
                    z = x.select("g");
        ...
        var c = a.models.parallelCoordinates(),
            ...
            o = null,
            p = null,
            q = d3.dispatch("dimensionsOrder", "brushEnd", "stateChange", "changeState", "renderEnd"),
            ...
            return Q.reset(), N.each(function (N) {
                function S() {
                    ...
                    if (M === !0) {
                        ...
                        var b = d3.geom.polygon([
                                [-10, -10],
                                [-10, i + 10],
                                [h + 10, i + 10],
                                [h + 10, -10]
                            ]),
                            c = d3.geom.voronoi(a).map(function (c, d) {
                                return {
                                    data: b.clip(c),
                                    series: a[d][2],
                                    point: a[d][3]
                        ...
                        var d = X.select(".nv-point-paths").selectAll("path").data(c),
                            e = d.enter().append("svg:path").attr("d", function (a) {
                        ...
                        var o = function (a, b) {
                            ...
                            if (void 0 !== c) {
                                ...
                                var e = l.node().getBoundingClientRect(),
                                    f = window.pageYOffset || document.documentElement.scrollTop,
                                    h = window.pageXOffset || document.documentElement.scrollLeft,
                                    i = {
                                        left: m(p(d, a.point)) + e.left + h + g.left + 10,
                                        top: n(q(d, a.point)) + e.top + f + g.top + 10
                                    };
                                b({
                                    point: d,
                                    series: c,
                                    pos: i,
                                    relativePos: [m(p(d, a.point)) + g.left, n(q(d, a.point)) + g.top],
                        ...
                        L.elementClick({
                            point: d,
                            series: c,
                            pos: [m(p(d, b)) + g.left, n(q(d, b)) + g.top],
                            relativePos: [m(p(d, b)) + g.left, n(q(d, b)) + g.top],
                            seriesIndex: a.series,
                            pointIndex: b
                        })
                    }).on("dblclick", function (a, b) {
                ...
                l = d3.select(this);
                var T = a.utils.availableWidth(h, l, g),
                    U = a.utils.availableHeight(i, l, g);
                ...
                var X = l.selectAll("g.nv-wrap.nv-scatter").data([N]),
                    Y = X.enter().append("g").attr("class", "nvd3 nv-wrap nv-scatter nv-chart-" + k),
                    Z = Y.append("defs"),
                    $ = Y.append("g"),
                    _ = X.select("g");
        ...
        function b(k) {
            return H.reset(), H.models(e), r && H.models(f), s && H.models(g), k.each(function (k) {
                ...
                e.dispatch.on("areaClick.toggle", function (a) {
                    ...
                    if (k.filter(function (a, b) {
                            ...
                            if (null != m && e.highlightPoint(k, f, !0), "undefined" != typeof l) {
                                ...
                                h.push({
                                    key: j.key,
                                    value: n,
                                    color: o(j, j.seriesIndex),
                                    stackedValue: l.display
                                }), v && "expand" != e.style() && (i += n)
                            }
                    ...
                    v && "expand" != e.style() && h.length >= 2 && h.push({
                        key: w,
                        value: i,
                        total: !0
                    });
                    ...
                    "expand" === e.style() || "stack_percent" === e.style() ? (G || (G = p), p = d3.format(".1%")) : G && (p = G, G = null), j.tooltip.chartContainer(H.parentNode).valueFormatter(p).data({
                        value: n,
                        series: h
                    })(), j.renderGuideLine(g)
                }), j.dispatch.on("elementMouseout", function (a) {
        ...
        function b(v) {
            return u.reset(), v.each(function (u) {
                ...
                function w(a) {
                    var b = d3.interpolate(q.domain(), [a.x, a.x + a.dx]),
                        c = d3.interpolate(r.domain(), [a.y, 1]),
                        d = d3.interpolate(r.range(), [a.y ? 20 : 0, A]);
                    return function (a, e) {
                        return e ? function (b) {
                            return t(a)
                        } : function (e) {
                ...
                l = d3.select(this);
                var x, y = a.utils.availableWidth(g, l, f),
                    z = a.utils.availableHeight(h, l, f),
                    A = Math.min(y, z) / 2;
                a.utils.initSVG(l);
                var B = l.selectAll(".nv-wrap.nv-sunburst").data(u),
                    C = B.enter().append("g").attr("class", "nvd3 nv-wrap nv-sunburst nv-chart-" + k),
                    D = C.selectAll("nv-sunburst");
                b.update = function () {
        ...
        var c, d, e, f = {
            ...
            q = d3.scale.linear().range([0, 2 * Math.PI]),
            r = d3.scale.sqrt(),
            s = d3.layout.partition().sort(null).value(function (a) {
                return 1
            }),
