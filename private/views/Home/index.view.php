...
<body>
    ...
    <!-- <a href="#" class="google-plus img-circle"><span class="fa fa-google-plus"></span></a> -->
                ...
                <div class="top-container">
                    ...
                    <div class="info-outer">
                        ...
                        <ul class="info-box clearfix">
                            <li><span class="icon flaticon-interface"></span><a href="#" class="google-plus img-circle">Recycohub@mail.com</a></li>
            ...
            <div class="header-upper">
                <div class="auto-container clearfix">
                    ...
                    <div class="nav-outer clearfix">
                        ...
                        <a href="<?=ROOT?>/login" class="theme-btn btn-donate" data-toggle="modal" data-target="#donate-popup">Login Now!</a>
                        <a href="<?=ROOT?>/signup" class="theme-btn btn-donate" data-toggle="modal" data-target="#donate-popup">Register Now!</a>
            ...
            <div class="tp-banner-container">
                <div class="tp-banner">
                    <ul>
                        ...
                        <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb="<?=ROOT?>/images/resource/mainslider1.jpeg" data-saveperformance="off" data-title="Awesome Title Here">
                            <img src="images/main-slider/1.jpg" alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">


                            <div class="tp-caption sfl sfb tp-resizeme" data-x="left" data-hoffset="15" data-y="center" data-voffset="-150" data-speed="1500" data-start="500" data-easing="easeOutExpo" data-splitin="none" data-splitout="none" data-elementdelay="0.01" data-endelementdelay="0.3" data-endspeed="1200" data-endeasing="Power4.easeIn">
                                <div class="circular-drop">0<sub>2</sub></div>
                            </div>

                            <div class="tp-caption sfr sfb tp-resizeme" data-x="left" data-hoffset="90" data-y="center" data-voffset="-50" data-speed="1500" data-start="1000" data-easing="easeOutExpo" data-splitin="none" data-splitout="none" data-elementdelay="0.01" data-endelementdelay="0.3" data-endspeed="1200" data-endeasing="Power4.easeIn">
                ...
                <div class="row clearfix">
                    ...
                    <div class="features-column col-lg-3 col-md-6 col-xs-12">
                        <article class="inner-box">
                            <div class="icon-box">
                                <img style="position: relative;width: 124px;" src="<?= ROOT ?>/images/icons/eco-light.png">
                    ...
                    <div class="features-column col-lg-3 col-md-6 col-xs-12">
                        <article class="inner-box">
                            <div class="icon-box">
                                <img style="position: relative;width: 124px;" src="<?= ROOT ?>/images/icons/recycle_arrow.png">
            ...
            <div class="outer clearfix">
                ...
                <article class="column text-column dark-column wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms" style="background-image:url(images/resource/fluid-image-2.jpg);">
                    ...
                    <div class="content-box pull-left">
                        ...
                        <div class="text">"Join Event Clean Recycling" is an exciting initiative aimed at bringing communities together to promote environmental stewardship and waste reduction.
                            Through organized events, participants will collaborate in cleaning up local areas while focusing on recycling and proper waste management practices.
                            This initiative not only fosters a sense of community involvement but also contributes to the preservation of natural habitats and the promotion of sustainable living.
        ...
        <!-- <section class="two-column-fluid" style="margin:40px">
                        ...
                        <div class="column default-featured-column style-two col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <article class="inner-box">
                                <figure class="image-box">
                                    <a href="#"><img src="<?= ROOT ?>/images/event/<?= $event->Event_ID ?>.jpg" alt=""></a>
                                </figure>
                                <div class="content-box">
                                    <h3><a href="#"><?= $event->Event_Title ?></a></h3>
                                    <div class="column-info"><?= $event->Event_location ?></div>
                                    <div class="text"><?= $event->Discription ?></div>
        ...
        <!--Testimonials-->
        <section class="testimonials-section" style="background-image:url(<?= ROOT ?>/images/resource/testimonial.jpeg);">
            <div class="auto-container">

                <div class="sec-title text-center">
                    <h2>Testi<span class="normal-font theme_color">Monials</span></h2>
                    <div class="text">"Discover how our recycling website is empowering individuals to make a difference in the world, one testimonial at a time." </div>
                </div>
                <!--Slider-->
                <div class="testimonials-slider testimonials-carousel">
                    ...
                    <?php foreach ($testimonials as $testimonial) { ?>
                        <article class="slide-item">
                            <div class="info-box">
                                <figure class="image-box"><img src="<?= ROOT ?>/images/Users/<?= $testimonial->User_ID ?>" alt=""></figure>
        ...
        <footer class="main-footer" style="background-image:url(images/background/footer-bg.jpg); margin-top:40px">
                ...
                <div class="auto-container">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="row clearfix" style="display: flex; justify-content: space-between;align-items: center;">
                                <!-- <div class="col-lg-8 col-sm-6 col-xs-12 column"> -->
                                    <div class="footer-widget about-widget" style="width:80%">
            ...
            <div class="footer-bottom">
                <div class="auto-container clearfix">
                    <!--Copyright-->
                    <div class="copyright text-center">Copyright 2024 &copy; By <a href="#">Recycohub</a> with love</div>
                </div>
            </div>
    ...
    <script src="js/indexgeneral.min.js"></script>
