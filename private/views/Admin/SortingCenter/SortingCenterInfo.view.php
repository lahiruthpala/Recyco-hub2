                    ...
                    <div class="form form--basic">
                        <div class="grid">
                            <div class="cell cell--3-col-desktop cell--3-col-tablet cell--1-col-phone"
                                style="width: 14%;border-right: 1px solid;">
                            ...
                            <div class="cell cell--8-col-desktop cell--8-col-tablet cell--4-col-phone form__article"
                                style="width: 60%;margin-left: 44px;">
                                <div style="display: flex; justify-content: space-between;">
                                    ...
                                    <div class="textfield js-textfield textfield--floating-label full-size"
                                        ...
                                        <label class="textfield__label" for="profile-floating-first-name">Sorting Center
                                            ID</label>
                                        <br>
                                        <br>
                                        <span
                                    ...
                                    <div class="textfield js-textfield textfield--floating-label full-size"
                                        style="width: 45%; display: inline-block; margin-right: 5%;">
                                        <label class="textfield__label" for="profile-floating-first-name">Address</label>
                                        <br>
                                        <br>
                                        <span
                                ...
                                <div class="textfield js-textfield textfield--floating-label full-size"
                                    ...
                                    <br>
                                    <br>
                                    <label class="textfield__label" for="profile-floating-first-name">Capacity</label>
                                    <span
                                        style="display: block; font-size: 100%;border-bottom: 1px solid white; padding-bottom: 1px ">
                                        <?= $row->capacity ?>
                                    </span>
