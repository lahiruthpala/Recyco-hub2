            ...
            <div class="mdl-cell mdl-cell--7-col-desktop mdl-cell--7-col-tablet mdl-cell--4-col-phone">
                <div class="mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                        <h5 class="mdl-card__title-text text-color--white">Create New Event</h5>
                    </div>
                            ...
                            <div class="mdl-grid">
                                <div
                                    ...
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                        <input class="mdl-textfield__input" type="text" id="floating-last-name" placeholder="Title" name="Event_Title" value="<?= isset($article->Artical_Title) ? $article->Artical_Title : '' ?>">
                                    ...
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                        <input class="mdl-textfield__input" type="date" id="floating-e-mail" placeholder="Content" name="Date" value="<?= isset($article->Data) ? $article->Data : '' ?>">
                                        <label class="mdl-textfield__label" for="floating-e-mail"></label>
                                    </div>
