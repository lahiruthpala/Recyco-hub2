            ...
            <form action="#" class="form">
                <div class="form__article">
                    ...
                    <div class="mdl-grid">
                        ...
                        <div
                            ...
                            <input class="mdl-textfield__input" value="Male" type="text" id="gender" readonly
                                tabIndex="-1" />
                ...
                <div class="form__article">
                    ...
                    <div class="mdl-grid">
                        ...
                        <div
                            class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input class="mdl-textfield__input" type="text" id="company_email"
                                value="hello@creativit.io" disabled />
                    ...
                    <div class="mdl-grid">
                        ...
                        <div
                            class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select">
                            <input class="mdl-textfield__input" value="Senior" type="text" id="qualification" readonly
                                tabIndex="-1" />
                            <label class="mdl-textfield__label" for="qualification">Qualification</label>
                            <ul class="mdl-menu mdl-menu--bottom-left mdl-js-menu dark_dropdown" for="qualification">
                ...
                <div class="form__article employer-form__contacts">
                    ...
                    <div class="mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--3-col mdl-textfield mdl-js-textfield getmdl-select">
                            <input class="mdl-textfield__input" value="Mobile" type="text" id="phone_type" readonly
                                tabIndex="-1" />
                    ...
                    <div class="mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--3-col mdl-textfield mdl-js-textfield getmdl-select">
                            <input class="mdl-textfield__input" value="Personal" type="text" id="skype_type" readonly
                                tabIndex="-1" />
                    ...
                    <div class="mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--3-col mdl-textfield mdl-js-textfield getmdl-select">
                            <input class="mdl-textfield__input" value="Work" type="text" id="email_type" readonly
                                tabIndex="-1" />
