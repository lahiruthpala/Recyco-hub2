...
<body id="top">
	...
	<div id="content">
					...
					<div class="grid_4">
						<div class="box">
							...
							<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
								laudantium, totam rem aperiam, eaque ipsa quae ab illo invtatis et quasi architecto
								beatae.</p>
						</div>
					</div>
					<div class="grid_4">
		...
		<div class="bg_2 p76">
			...
			<div id="owl" class="owl-carousel">
				<div class="item">
					<div class="thumbs">
						<img src="<?= ROOT ?>/images/page1_img1.jpg" class="lazyOwl img_box"
							data-src="<?= ROOT ?>/images/page1_img1.jpg" alt="">
						<div class="capture">
				...
				<div class="item">
					<div class="thumbs">
						<img src="<?= ROOT ?>/images/page1_img2.jpg" class="lazyOwl img_box"
							data-src="<?= ROOT ?>/images/page1_img2.jpg" alt="">
						<div class="capture">
							<time datetime="2014-12-14">14 Dec, 2014</time>
							<span>Sed ut pe oluptatem accusantium remque laudantium, to rem ap.</span>
							<img src="<?= ROOT ?>/images/comment.png" alt=""><a href="#">3 Comments</a>
				...
				<div class="item">
					<div class="thumbs">
						<img src="<?= ROOT ?>/images/page1_img3.jpg" class="lazyOwl img_box"
							data-src="<?= ROOT ?>/images/page1_img3.jpg" alt="">
						<div class="capture">
							<time datetime="2014-12-14">14 Dec, 2014</time>
							<span>Sed ut pe oluptatem accusantium remque laudantium, to rem ap.</span>
							<img src="<?= ROOT ?>/images/comment.png" alt=""><a href="#">3 Comments</a>
				...
				<div class="item">
					<div class="thumbs">
						<img src="<?= ROOT ?>/images/page1_img4.jpg" class="lazyOwl img_box"
							data-src="<?= ROOT ?>/images/page1_img4.jpg" alt="">
						<div class="capture">
							<time datetime="2014-12-14">14 Dec, 2014</time>
							<span>Sed ut pe oluptatem accusantium remque laudantium, to rem ap.</span>
							<img src="<?= ROOT ?>/images/comment.png" alt=""><a href="#">3 Comments</a>
				...
				<div class="item">
					<div class="thumbs">
						<img src="<?= ROOT ?>/images/page1_img5.jpg" class="lazyOwl img_box"
							data-src="<?= ROOT ?>/images/page1_img5.jpg" alt="">
						<div class="capture">
							<time datetime="2014-12-14">14 Dec, 2014</time>
							<span>Sed ut pe oluptatem accusantium remque laudantium, to rem ap.</span>
							<img src="<?= ROOT ?>/images/comment.png" alt=""><a href="#">3 Comments</a>
				...
				<div class="item">
					<div class="thumbs">
						<img src="<?= ROOT ?>/images/page1_img6.jpg" class="lazyOwl img_box"
							data-src="<?= ROOT ?>/images/page1_img6.jpg" alt="">
						<div class="capture">
							<time datetime="2014-12-14">14 Dec, 2014</time>
							<span>Sed ut pe oluptatem accusantium remque laudantium, to rem ap.</span>
							<img src="<?= ROOT ?>/images/comment.png" alt=""><a href="#">3 Comments</a>
				...
				<div class="item">
					<div class="thumbs">
						<img src="<?= ROOT ?>/images/page1_img7.jpg" class="lazyOwl img_box"
							data-src="<?= ROOT ?>/images/page1_img7.jpg" alt="">
						<div class="capture">
							<time datetime="2014-12-14">14 Dec, 2014</time>
							<span>Sed ut pe oluptatem accusantium remque laudantium, to rem ap.</span>
							<img src="<?= ROOT ?>/images/comment.png" alt=""><a href="#">3 Comments</a>
			...
			<div class="container">
				<div class="row">
					<div class="grid_6">
						...
						<ul class="list">
							<li><i class="fa fa-plus-square"></i><a href="#">Epsum factorial non deposit quid pro quo
									hic escorol</a></li>
							<li><i class="fa fa-plus-square"></i><a href="#">Olypian quarrel gorilla congolium</a></li>
							<li><i class="fa fa-plus-square"></i><a href="#">Gorilla congolium sic ad nauseum uvlaki
									ignitus</a></li>
							<li><i class="fa fa-plus-square"></i><a href="#">Defacto lingo est igpay atinlay quee</a>
							</li>
						</ul>
					</div>
					<div class="grid_6">
					...
					<div class="grid_6">
						<div class="block">
							...
							<div class="text">
								...
								<p>Vestibulum iaculis lacinia est. Pro. Fusce euismod consequat ante. Lorem ipsum dolor
									sit amet, consectetuer adipiscing elit. Pellentesque sed dolor. Aliquam congue ntum
									nisl. Mauris accumsan nulla vel diam.</p>
							</div>
						</div>
						<div class="block">
							<div class="image1">
						...
						<div class="grid_4">
							<div class="block1">
								...
								<div class="text">
									...
									<p>Sed ut perspiciatis unde oiste natus error sit voluptatem accusantiu doloremque
			...
			<div id="owl1" class="owl-carousel">
				<div class="item">
					...
					<blockquote><span class="bq1"><img src="<?= ROOT ?>/images/bq1.png" alt=""></span>
						<p>Vestibnisl, porta vel, sceleris lesuada at, neque. Vivamus eget nibh. Etiam curs leo vel
							metus. Nulla facilisi. Aenean nec eros. Vestibulum ante ipsum. primis in faucibus orci
				...
				<div class="item">
					<h3>Testimonials</h3>
					<blockquote><span class="bq1"><img src="<?= ROOT ?>/images/bq1.png" alt=""></span>
						<p>FVestibnisl, porta vel, sceleris lesuada at, neque. Vivamus eget nibh. Etiam curs leo vel
							metus. Nulla facilisi. Aenean nec eros. Vestibulum ante ipsum. primis in faucibus orci
							luctus et ultrices posuere cubilia.</p>
					</blockquote>
					<a href="#">Mark Bridges</a>
					...
					<div class="grid_3">
						<div class="thumbnail">
							...
							<div class="caption1">
								...
								<p>Vestibnisl, porta vel, sceleris lesuada at, neque. Vivamus eget nibh. Etiam curs leo
									vel metus. Nulla facilisi.</p>
	...
	<footer id="footer">
		<div class="container">
			<div class="row">
				<div class="grid_12">
					<div class="copy"><a class="link3" href="index.html">Waste Management Co.</a>&nbsp;&copy;&nbsp;<span
							id="copyright-year"></span>&nbsp;
						<a class="link4" href="index-6.html">Privacy policy</a> <!--{%FOOTER_LINK} -->
					</div>
				</div>
			</div>
			<div class="row">
